...
import { RolAuditoriaListadoItem } from '../../models/auth.model';
import { PageHeaderComponent } from '../../shared/components/page-header/page-header.component';

@Component({
  selector: 'app-auditoria-roles-page',
  standalone: true,
  imports: [CommonModule, PageHeaderComponent],
  templateUrl: './auditoria-roles-page.component.html',
  styleUrl: './auditoria-roles-page.component.scss'
})
export class AuditoriaRolesPageComponent {
  private readonly rolesService = inject(RolesService);

  protected items: RolAuditoriaListadoItem[] = [];
  ...
  protected cargar(): void {
    ...
    this.rolesService
      ...
      .pipe(
        catchError(() => {
          this.error = 'No fue posible cargar la auditoria administrativa de roles.';
          this.items = [];
          this.totalPages = 0;
          this.totalItems = 0;
          return of(null);
